...
__socket_host__ = __addon__.getSetting('hls_server_host')
__socket_port__ = int(__addon__.getSetting('hls_server_port'))
...
def rewind_playlist(m3u8_obj, start_at, segment_base_uri, key_headers={}):
	...
	# FIXME: I'd LOVE for a way to be more accurate for this.
...
if __name__ == '__main__':
	if __socket_port__ < 1024 or __socket_port__ > 65535:
		raise ValueError('HLS socket port must be between 1024 and 65535.')
